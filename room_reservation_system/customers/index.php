...
<head>
    ...
    <title>RoomReservation - Customers</title>
</head>
...
<body>
    ...
    <div class="d-flex justify-content-center">
        <form action="" method="post" class="w-50">
            ...
            <div class="pt-2">
                <?php  inputElement("text", "<i class='fas fa-file-signature'></i>", "Customer name", "cust_name", "");  ?>
            </div>
            <div class="row pt-2">
                <div class="col">
                    <?php  inputElement("text", "<i class='fas fa-phone-alt'></i>", "Phone", "cust_phone", "");  ?>
                </div>
                <div class="col">
                    <?php  inputElement("text", "<i class='fas fa-envelope'></i>", "Email", "email", "");  ?>
                </div>
            </div>
            <div class="d-flex justify-content-center">
    ...
    <div class="d-flex table-data container">
        <table class="table table-striped table-dark">
            ...
            <tbody id="tbody">
                ...
                <tr>
                    <td data-id="<?php echo $row['cust_id']; ?>"><?php echo $row['cust_id']; ?></td>
                    <td data-id="<?php echo $row['cust_id']; ?>"><?php echo $row['cust_name']; ?></td>
                    <td data-id="<?php echo $row['cust_id']; ?>"><?php echo $row['cust_phone']; ?></td>
                    <td data-id="<?php echo $row['cust_id']; ?>"><?php echo $row['email']; ?></td>
                    <td><i class="fas fa-edit btnedit" data-id="<?php echo $row['cust_id']; ?>"></i></td>
                </tr>
