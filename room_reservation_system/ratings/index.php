...
<head>
    ...
    <title>RoomReservation - Ratings</title>
</head>
...
<body>
    ...
    <div class="d-flex justify-content-center">
        <form action="" method="post" class="w-50">
            ...
            <div class="pt-2">
                <?php  inputElement("text", "<i class='fas fa-star'></i>", "Rating", "rating", "");  ?>
            </div>
            <div class="d-flex justify-content-center">
        ...
        <table class="table table-striped table-dark">
            ...
            <tbody id="tbody">
                ...
                <tr>
                    ...
                    <td data-id="<?php echo $row['cust_id']; ?>"><?php echo $row['room_id']; ?></td>
                    <td data-id="<?php echo $row['cust_id']; ?>"><?php echo $row['rating']; ?></td>
