...
function deleteData() {
    ...
    if($cust_id && $room_id) {
        ...
        delete from ratings where cust_id = '$cust_id' and room_id = '$room_id';
        ...
        textNode("alert alert-danger alert-dismissible fade show", "Please provide the Customer ID and the Room ID");
    }
}