...
<head>
    ...
    <title>RoomReservation - Reservations</title>
</head>
...
<body>
    ...
    <div class="d-flex justify-content-center">
        <form action="" method="post" class="w-50">
            <div class="pt-2">
                <?php  inputElement("text", "<i class='fas fa-person-booth'></i>", "Reservation ID", "res_id", "");  ?>
            </div>
            <div class="row pt-2">
                <div class="col">
                    <?php  inputElement("text", "<i class='fas fa-id-badge'></i>", "Customer  ID", "cust_id", "");  ?>
                </div>
                <div class="col">
            ...
            <div class="row pt-2">
                <div class="col">
                    <?php  inputElement("date", "<i class='fas fa-sign-in-alt'></i>", "Start date", "start_date", "");  ?>
                </div>
                <div class="col">
                    <?php  inputElement("date", "<i class='fas fa-sign-out-alt'></i>", "End date", "end_date", "");  ?>
                </div>
            </div>
            <div class="d-flex justify-content-center">
    ...
    <div class="d-flex table-data container">
        <table class="table table-striped table-dark">
            ...
            <tbody id="tbody">
                ...
                <tr>
                    <td data-id="<?php echo $row['res_id']; ?>"><?php echo $row['res_id']; ?></td>
                    <td data-id="<?php echo $row['res_id']; ?>"><?php echo $row['cust_id']; ?></td>
                    <td data-id="<?php echo $row['res_id']; ?>"><?php echo $row['room_id']; ?></td>
                    <td data-id="<?php echo $row['res_id']; ?>"><?php echo $row['start_date']; ?></td>
                    <td data-id="<?php echo $row['res_id']; ?>"><?php echo $row['end_date']; ?></td>
                    <td><i class="fas fa-edit btnedit" data-id="<?php echo $row['res_id']; ?>"></i></td>
                </tr>
